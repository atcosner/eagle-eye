...
TOP_REGION = {
    ...
    # TextField(name='GPS Waypoint', visual_region=BoxBounds(x=860, y=224, width=164, height=34), allow_copy=False, validator=val.NoValidation),
    # TextField(name='Error (m)', visual_region=BoxBounds(x=1120, y=225, width=108, height=33), validator=val.NoValidation),
    #
    # TextField(name='Species', visual_region=BoxBounds(x=253, y=262, width=594, height=33), allow_copy=False, validator=val.NoValidation),
    # TextField(name='Coordinate Source', visual_region=BoxBounds(x=997, y=262, width=235, height=33), allow_copy=False, validator=val.NoValidation),
    #
    ...
    # TextField(name='Collector', visual_region=BoxBounds(x=790, y=299, width=435, height=33), allow_copy=False, validator=val.NoValidation),
    #
    # TextField(name='Habitat', visual_region=BoxBounds(x=217, y=336, width=1012, height=32), allow_copy=False, validator=val.NoValidation),
    #
    # MultiCheckboxField(
    ...
    # ),
    # TextField(name='Bill', visual_region=BoxBounds(x=577, y=412, width=648, height=31), allow_copy=False, validator=val.NoValidation),
    #
    # TextField(name='Feet/Legs', visual_region=BoxBounds(x=242, y=450, width=726, height=30), allow_copy=False, validator=val.NoValidation),
    # TextField(name='Weight (g)', visual_region=BoxBounds(x=1035, y=447, width=190, height=33), validator=val.NoValidation),
    #
    # MultiCheckboxField(
    #     name='Tissue Date',
    ...
    # ),
    #
    # TextField(name='Tissues', visual_region=BoxBounds(x=251, y=520, width=147, height=35), validator=val.NoValidation),
    # TextField(name='No. Tubes', visual_region=BoxBounds(x=509, y=523, width=56, height=32), validator=val.NoValidation),
    # MultiCheckboxField(
    ...
    # TextField(name='Preparator', visual_region=BoxBounds(x=776, y=562, width=451, height=30), validator=val.NoValidation,),
    #
    # MultiCheckboxField(
    #     name='Preps',
    ...
    # ),
    #
    # TextField(name='Molt', visual_region=BoxBounds(x=220, y=634, width=1004, height=32), validator=val.NoValidation),
    #
    # TextField(name='Gonads', visual_region=BoxBounds(x=255, y=671, width=967, height=31), validator=val.NoValidation),
    #
    # TextField(name='Skull', visual_region=BoxBounds(x=222, y=706, width=257, height=34), validator=val.NoValidation),
    # MultiCheckboxField(
    #     name='Fat',
    ...
    #     ],
    # ),
    # TextField(name='Bursa', visual_region=BoxBounds(x=980, y=709, width=243, height=31), validator=val.NoValidation),
    #
    # TextField(name='Stomach', visual_region=BoxBounds(x=232, y=745, width=992, height=32), validator=val.NoValidation),
    #
    # MultiCheckboxField(
    #     name='Sex',
    ...
    #     ],
    # ),
    # TextField(name='Age', visual_region=BoxBounds(x=579, y=783, width=315, height=31), validator=val.NoValidation),
    # MultiCheckboxField(
